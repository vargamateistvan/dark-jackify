...
<script>
import GameScratch from "@/assets/html/game-scratch.html?raw";
...
export default {
  ...
  methods: {
    renderHTMLToCanvas() {
      ...
      const svg = `
        <svg xmlns="http://www.w3.org/2000/svg" width="${382}" height="${254}">
            <foreignObject width="100%" height="100%">
                <div xmlns="http://www.w3.org/1999/xhtml">${GameScratch}</div>
            </foreignObject>
        </svg>`;
    ...
    //   const { offsetX, offsetY, changedTouches } = e;
    //   const x = changedTouches
    //     ? changedTouches[0].clientX - this.canvas.offsetLeft
    //     : offsetX;
    //   const y = changedTouches
    //     ? changedTouches[0].clientY - this.canvas.offsetTop
    //     : offsetY;
    ...
    // },
    // checkReveal() {
    //   console.log("CTX", this.ctx, this.canvas);
    ...
    //   if (transparentPercentage >= revealPercent) {
    //     // Content is revealed, show the revealed div
